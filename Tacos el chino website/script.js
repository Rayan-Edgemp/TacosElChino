(() => {
  ...
  const galleryPageFoodTiles = Array.from(
    document.querySelectorAll(
      '.gallery-page [data-reveal="food-gallery"] .gallery-tile'
    )
  );
  ...
  if (revealSections.length) {
    ...
    const revealChildren = {
      ...
      "food-gallery": ".gallery-heading, .gallery-tile",
      "drinks-gallery": ".gallery-heading, .gallery-tile",
    ...
    galleryPageFoodTiles.forEach((tile) => {
      tile.classList.add("reveal-by-item");
      tile.style.removeProperty("--reveal-child-delay");
    });
    ...
    if (reducedMotion || !("IntersectionObserver" in window)) {
      ...
      galleryPageFoodTiles.forEach(revealSection);
    } else {
      ...
      if (galleryPageFoodTiles.length) {
        ...
        galleryPageFoodTiles.forEach((tile) => {
          galleryImageObserver.observe(tile);
        });
      }
    }
  }
